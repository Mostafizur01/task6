...
export default function Home() {
  ...
  const fetchHistory = async () => {
    try {
      ...
      // backend route is mounted at /api/history and the router defines /history/:name
      const response = await fetch(`http://localhost:3000/api/history/history/${userName}`);
